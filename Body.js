...
const Body = () => {
  ...
  async function getRestaurant() {
    ...
    const data = await fetch("https://www.swiggy.com/dapi/restaurants/list/v5?lat=23.1997451&lng=79.9099173&is-seo-homepage-enabled=true&page_type=DESKTOP_WEB_LISTING");
